...
OTS_ENDPOINT = get_env('OTS_ENDPOINT', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx')
...
# 阿里云密钥（与原代码一致，含空值校验）
ALIYUN_ACCESS_KEY = get_env('ALIYUN_ACCESS_KEY', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')
ALIYUN_ACCESS_SECRET = get_env('ALIYUN_ACCESS_SECRET', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')
...
EMAIL_USER = get_env('EMAIL_USER', '3438378487@qq.com')
EMAIL_PASSWORD = get_env('EMAIL_PASSWORD', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')

# AI配置（DeepSeek）
DEEPSEEK_API_KEY = get_env('DEEPSEEK_API_KEY', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')
